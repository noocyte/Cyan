...
namespace Cyan.Interfaces
{
    public interface ICyanTable
    {
        ...
        IEnumerable<CyanEntity> Query(string partition = null,
            string row = null,
            string filter = null,
            int top = 0,
        ...
        CyanEntity Insert(CyanEntity entity);

        bool TryInsert(CyanEntity entity);
        bool TryInsert(CyanEntity entity, out CyanEntity insertedEntity);
        ...
        bool TryUpdate(CyanEntity entity);
        ...
        /// <param name="fields">The name of the fields to be updated.</param>
        /// <returns><code>true</code> if the entity ETag matches.</returns>
        bool TryMerge(CyanEntity entity, params string[] fields);
        ...
        CyanEntity InsertOrUpdate(CyanEntity entity);
        CyanEntity InsertOrMerge(CyanEntity entity, params string[] fields);
        ICyanEGT Batch();
