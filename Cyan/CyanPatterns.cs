...
//    {
//        public async static Task<CyanEntity> InsertOrUpdate(this CyanTable table,
//            string partitionKey,
//            string rowKey,
...
//            do
//            {
//                var result = await table.Query(partitionKey, rowKey);
...
//                    entity = await table.TryInsert(entityProvider());
...
//        public static async  Task<dynamic> InsertOrMerge(this CyanTable table,
//            string partitionKey,
//            string rowKey,
//            Func<CyanEntity> entityProvider,
...
//        public static async Task<dynamic> Update(this CyanTable table,
//            string partitionKey,
//            string rowKey,
...
//        public async static Task<IEnumerable<dynamic>> BatchUpdate(this CyanTable table,
